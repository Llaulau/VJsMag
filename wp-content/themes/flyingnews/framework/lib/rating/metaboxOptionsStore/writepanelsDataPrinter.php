...
/**
 * 
 * podivejte se na funkci printTypeRating
 *
 */
class fwWritepanelsDataPrinter {
    ...
    private function _printRating($id, $rating, $one_option) {
        ...
        echo '<select value="' . $rating['type'] . '" data-name="type" id="' . $this->_getMultiId($one_option['id'], $id, 'type') . '" name="' . $this->_getMultiId($one_option['id'], $id, 'type') . '" >';
        
        if ($rating['type'] == "stars") {
            echo '<option selected="selected" value="stars">Stars</option>';
        } else {
            echo '<option value="stars">Stars</option>';
        }
        if ($rating['type'] == "percent") {
            echo '<option selected="selected" value="percent">Percent</option>';
        } else {
