jQuery(document).ready(function($) {
    ...
    $('.add_new_rating').click(function() {
        ...
        nr += '<select data-name="type" id="' + _getMultiId( $actualOption, $actualId, 'type') +'" name="' + _getMultiId( $actualOption, $actualId, 'type') +'" >';
        nr += '<option value="stars">Stars</option>';
        nr += '<option value="percent">Percent</option>';
        nr += '</select>';
