...
/**
 * Same classs as in wp-admin/includes/nav-menu.php line 10. Just added 
 * do_action jw_walker_nav_menu_edit_add_fields, so we can hook it and add new
 * custom fields by other classes
 */


add_filter( 'wp_edit_nav_menu_walker', 'jw_nav_menu_edit_filter');
function jw_nav_menu_edit_filter ( $old_name ) { return 'custom_walker_nav_menu_edit_with_customfields'; }
/**
 ...
 */
class custom_walker_nav_menu_edit_with_customfields extends Walker_Nav_Menu {
	/**
	...
	function start_el(&$output, $item, $depth, $args) {
		...
		<li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
			...
			<div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
				...
				<?php do_action('jw_walker_nav_menu_edit_add_fields', $item_id); ?>
