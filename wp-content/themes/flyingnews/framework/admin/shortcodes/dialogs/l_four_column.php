...
<script>
    jQuery("#insert-button").click(function () {
        ...
        tinymce.activeEditor.selection.setContent('[one_fourth]'+column1+'[/one_fourth][one_fourth]'+column2+'[/one_fourth][one_fourth]'+column3+'[/one_fourth][one_fourth_last]'+column4+'[/one_fourth_last]');
