...
<script>
    jQuery("#insert-button").click(function () {
        ...
        tinymce.activeEditor.selection.setContent('[one_sixth]'+column1+'[/one_sixth][one_sixth]'+column2+'[/one_sixth][one_sixth]'+column3+'[/one_sixth][one_half_last]'+column4+'[/one_half_last]');
