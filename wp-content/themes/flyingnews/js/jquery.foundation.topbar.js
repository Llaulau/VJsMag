    ...
    methods = {
      init : function (options) {
        return this.each(function () {
          ...
          settings.$w = $(window),
          settings.$topbar = $('nav.mobile-menu');
          ...
          $('.mobile-menu .toggle-topbar').live('click.fndtn', function (e) {
            e.preventDefault();
          ...
          $('.mobile-menu .has-dropdown>a').live('click.fndtn', function (e) {
            e.preventDefault();
            ...
            if (methods.breakpoint()) {
              ...
              settings.$topbar.css({'min-height': '81px'})
            }
          });

          // Go up a level on Click
          $('.mobile-menu .has-dropdown .back').live('click.fndtn', function (e) {
            e.preventDefault();
