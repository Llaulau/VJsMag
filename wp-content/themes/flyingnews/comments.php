...
//                                printf(__('%1$s on %2$s <span class="says">said:</span>', 'jawtemplates'), sprintf('<span class="fn">%s</span>', get_comment_author_link()), sprintf('<a href="%1$s"><time pubdate datetime="%2$s">%3$s</time></a>', esc_url(get_comment_link($comment->comment_ID)), get_comment_time('c'),
//                                                /* translators: 1: date, 2: time */ sprintf(__('%1$s at %2$s', 'jawtemplates'), get_comment_date(), get_comment_time())
//                                        )
//                                );
                                //printf('<a href="%1$s"><time pubdate datetime="%2$s">%3$s</time></a>', ),get_comment_date(), get_comment_time());
                                ?>
        ...
        <?php if (have_comments()) : ?>
            <section id="comments">
                ...
                <footer>
                    <nav id="comments-nav">
                        <div class="comments-previous"><?php previous_comments_link(__('&larr; Older comments', 'jawtemplates')); ?></div>
                        <div class="comments-next"><?php next_comments_link(__('Newer comments &rarr;', 'jawtemplates')); ?></div>
                    </nav>
                </footer>
            </section>
